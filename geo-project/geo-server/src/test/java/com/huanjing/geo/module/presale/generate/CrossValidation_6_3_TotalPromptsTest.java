...
class CrossValidation_6_3_TotalPromptsTest {

    @Test
    void validate_throwsWhenTotalPromptsInconsistent() {
        ...
        cells.get(0).setTotalPrompts(9);

        assertThatThrownBy(() -> validator.validate(platforms, intents, cells))
                .isInstanceOf(BizException.class)
                .hasMessageContaining("total_prompts mismatch");
    }
