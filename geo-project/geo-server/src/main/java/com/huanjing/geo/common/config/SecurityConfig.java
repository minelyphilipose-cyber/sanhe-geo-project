    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/extension/runtime-config").permitAll()
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/extension/runtime-status").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/v1/extension/browser-environment-login-status").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/v1/extension/brands/*/browser-environment-login-status").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/local-agent/session/status").permitAll()
