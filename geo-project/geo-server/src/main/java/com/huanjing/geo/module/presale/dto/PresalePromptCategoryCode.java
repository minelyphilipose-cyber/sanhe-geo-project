...
public enum PresalePromptCategoryCode {
    RECOMMENDATION(
            ...
            "定位: 用户有购买意图但未锁定品牌,希望大模型直接推荐商家或品牌,测试品牌在自然语境下的 AI 召回能力。\n"
                    + "要点: 包含“哪家好”“推荐”“选哪个”等求推荐信号词;带地域、预算或场景限定;不主动提及目标品牌名。"
    ),
    COMPARISON(
            "对比型",
            "CMP",
    ...
    PROBLEM(
            ...
            "定位: 用户带着疑虑、纠结、避坑心态提问,测试 AI 在用户存在负面预设时的品牌呈现倾向。\n"
                    + "要点: 句式以“会不会”“怎么办”“坑不坑”“靠不靠谱”等担忧型表达为主;涵盖质量、售后、价格、施工、合同、维护等真实痛点;必须从行业、地区、场景或用户痛点发问,不要直接提及目标品牌名,用于观察 AI 是否会自然召回目标品牌。"
    ),
    COGNITIVE(
            "认知型",
            "CGN",
    ...
    SCENARIO(
            ...
            "定位: 用户描述具体生活情境,如房型、预算、家庭、装修阶段等,寻求针对性建议,最贴近真实决策路径。\n"
                    + "要点: 必须包含具体场景要素,如房型/面积、装修阶段、家庭成员、预算、特殊需求;典型句式为“我家 XX 情况,怎么办/找谁/选啥”;用户画像需多样化,避免集中。"
    );
