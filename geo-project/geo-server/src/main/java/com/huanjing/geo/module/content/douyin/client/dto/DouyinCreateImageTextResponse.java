...
@NoArgsConstructor
@AllArgsConstructor
public class DouyinCreateImageTextResponse {
    /** Official field: data.item_id. Reviewed 2026-05-05. */
    @JsonProperty("item_id")
    private String itemId;

    /** Official field: data.video_id. Reviewed 2026-05-05. */
    ...
    /**
     * Mock-only field. Real Douyin create_image_text succeeds before review outcome is known;
     * A.6 can use this marker to simulate later review refresh behavior.
     */
    @JsonProperty("_mock_review_outcome")
    private String mockReviewOutcome;
