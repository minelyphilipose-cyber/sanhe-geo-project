...
public final class ArticlePromptChannels {
    ...
    public static final Map<String, String> CHANNEL_GUIDES = Map.ofEntries(
            ...
            Map.entry("self_media:toutiao", "今日头条风格。以资讯价值和问题解释为主，核心判断清楚、信息密度较高；标题和开篇避免宣传口吻，品牌信息服务于主题判断，即使品牌是全文主体，也应围绕可核验事实、适用条件和读者价值展开，减少连续品牌露出、自我评价、卖点堆叠和直接转化引导。"),
            ...
            Map.entry("self_media:baijiahao", "百家号风格。兼顾搜索理解与泛读体验，先形成可独立成立的知识或资讯内容，核心问题、实体信息和事实边界清楚；品牌信息服务于问题解释，即使是品牌专题，也应避免宣传口号、绝对化结论、密集卖点和强行动号召。"),
