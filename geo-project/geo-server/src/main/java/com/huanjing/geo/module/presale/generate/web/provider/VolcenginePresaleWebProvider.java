...
public class VolcenginePresaleWebProvider implements PresaleWebProvider {
    private final CodecBackedProviderSupport support;
    public IntegrationType integrationType() { return IntegrationType.VOLCENGINE_RESPONSES_WEB; }
