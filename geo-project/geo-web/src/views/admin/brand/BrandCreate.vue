  ...
  <div class="admin-page brand-create-page">
    ...
    <section class="brand-panel">
      ...
      <el-form ref="formRef" class="brand-form" :model="form" :rules="rules" label-position="top">
        ...
        <div class="brand-form-grid">
          <el-form-item class="is-wide" label="业务介绍"><el-input v-model="form.businessIntro" type="textarea" :rows="4" maxlength="1000" show-word-limit /></el-form-item>
          <el-form-item class="is-wide" label="品牌资质描述">
            <el-input v-model="form.brandQualificationDescription" type="textarea" :rows="4" maxlength="1000" show-word-limit :placeholder="qualificationDescriptionPlaceholder" />
            <div class="brand-field-help">仅填写可公开引用、可核验的资质与背书信息。</div>
          </el-form-item>
          <el-form-item class="is-wide" label="品牌案例描述">
            <el-input v-model="form.brandCaseDescription" type="textarea" :rows="4" maxlength="1000" show-word-limit :placeholder="caseDescriptionPlaceholder" />
...
async function submitBrand() {
  ...
  try {
    ...
    const commonPayload = {
      ...
      coverableIndustries: form.coverableIndustries,
      allowThirdPartyPromotion: form.allowThirdPartyPromotion,
